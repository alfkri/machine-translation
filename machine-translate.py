...
class TranslateApp:
    def __init__(self, root):
        ...
        # Variabel String untuk teks input, output, dan prounsiasi
        ...
        title_label = ttk.Label(root, text="Translator", font=("Helvetica", 20), background="#3498db", foreground="white")
        ...
        label_pronunciation = ttk.Label(root, text="Pengucapan:", font=("Helvetica", 12), background="#3498db", foreground="white")
